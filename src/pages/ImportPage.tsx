...
export default function ImportPage() {
  const { t } = useLanguage();
  const details = t("importPage.features") as any[];
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-navy mb-6 break-keep">{t("importPage.section1Title")}</h2>
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed break-keep">
                {t("importPage.section1P1")}
              </p>
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed break-keep">
                {t("importPage.section1P2")}
              </p>
            </motion.div>
