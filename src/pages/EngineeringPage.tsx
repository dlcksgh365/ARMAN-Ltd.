        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-navy mb-6 break-keep">{t("engineeringPage.section1Title")}</h2>
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed break-keep whitespace-pre-line">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="aspect-[4/3] bg-muted overflow-hidden md:mt-12">
                <img 
                  src="/m3.png" 
